        ...
        with gr.Row():
            negative_prompt2 = gr.Textbox(label="Negative prompt3", show_label=False,
                                          ...
                                          value="multiple breasts, (mutated hands and fingers:1.5 ), (long body :1.3), "
                                                ...
                                                "anatomical nonsense, text font ui, error, malformed hands, long neck, "
                                                "blurred, lowers, lowres, bad anatomy, bad proportions, bad shadow, "
                                                "uncoordinated body, unnatural body, fused breasts, bad breasts, "
                                                "huge breasts, poorly drawn breasts, extra breasts, liquid breasts, "
                                                "heavy breasts, missing breasts, huge haunch, huge thighs, huge calf, "
                                                "bad hands, fused hand, missing hand, disappearing arms, disappearing "
                                                "thigh, disappearing calf, disappearing legs, fused ears, bad ears, "
                                                "poorly drawn ears, extra ears, liquid ears, heavy ears, missing ears, "
                                                "fused animal ears, bad animal ears, poorly drawn animal ears, "
                                                "extra animal ears, liquid animal ears, heavy animal ears, "
                                                "missing animal ears, text, ui, error, missing fingers, missing limb, "
                                                "fused fingers, one hand with more than 5 fingers, one hand with less "
                                                "than 5 fingers, one hand with more than 5 digit, one hand with less "
                                                "than 5 digit, extra digit, fewer digits, fused digit, missing digit, "
                                                ...
                                                "ugly, bad face, fused face, poorly drawn face, cloned face, big face, "
                                                ...
                                                "black clit, liquid clit, QR code, bar code, censored, safety panties, "

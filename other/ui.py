    ...
    with gr.Blocks(analytics_enabled=False) as txt2img_interface:
        ...
        with gr.Row().style(equal_height=False):
            with gr.Column(variant='panel'):
                ...
                with gr.Group():
                    useTheFollowingPrompt = gr.Checkbox(label="useTheFollowingPrompt", value=False)
                    isRandom = gr.Checkbox(label="isRandom", value=False)
                    methodName = gr.Textbox(label="methodName", lines=1, value="getRandomPrompt")
                    quality = gr.Textbox(label="quality", lines=1,
                    ...
                    characterPartNumIsRandom = gr.Checkbox(label="characterPartNumIsRandom", lines=1, value=False)
                    characterPartNum = gr.Slider(label="characterPartNum", lines=1, minimum=0, maximum=10, value=0,
                                                 step=1)
                    ...
                    nsfwDescribeNum = gr.Slider(label="nsfwDescribeNum", lines=1, minimum=0, maximum=10, value=0,
                                                step=1)
            ...
            txt2img_args = dict(
                ...
                inputs=[
                           ...
                           characterPartNum,
                           characterPartRandomWeight,
                           nsfwDescribeNumIsRandom,
                           nsfwDescribeNum,
